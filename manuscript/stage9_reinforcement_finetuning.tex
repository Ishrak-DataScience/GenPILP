% ============================================================================
% Methods -- Property-guided reinforcement fine-tuning of ChemBERTa on
% interaction- and randomly masked SMILES (companion "expert-iteration"
% method is in main.tex; the two are a controlled comparison of estimators
% and share training data, masking rate and rollout distribution).
%
% Drop this file into the Methods section of your Nature-format manuscript,
% e.g. with \input{stage9_reinforcement_finetuning}, ahead of the
% best-of-K selection subsection in main.tex, since that subsection's
% equation and table cross-references (eq:stage9-loss, eq:stage9-score,
% eq:stage9-kl, eq:stage9-logprob, tab:stage9-hparams, sec:stage9) are
% defined here. Merge references.bib into your bibliography resource
