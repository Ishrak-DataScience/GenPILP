...
# the machine doing the import. Set GENPLIP_CONFIG=hpc_jupyter to force this one.
# Meant for: the HPC Jupyter node (SLURM allocation).
CONFIG_PLATFORM = "hpc_jupyter"

# ── Root directory ─────────────────────────────────────────────────────────────
BASE_DIR    = "/home/h2/mois020f/GenPLIP"  # root of the pipeline tree (all outputs live under this)
USER_PREFIX = "Ishrak"
EXPERIMENT_TAG = "expo_finetuning_compound_loss_random_split"
...
# HPC: the archive sits on the cluster filesystem under BASE_DIR, summary CSV
# read straight out of the tar.gz without full extraction (see note above).
STAGE9_9A_STAGE1B_DATA_DIR = f"{BASE_DIR}/Dummy_data/stage1b_output.tar.gz"
...
STAGE10_1_CHECKPOINT_EVERY_STEPS = 500
...
STAGE10_2_BATCHED_FORWARD = "auto"       # "auto" | True | False
...
STAGE10_2_AMP = "auto"                 # "auto" | "bf16" | "fp16" | False
...
STAGE10_2_GRAD_SCALER = "auto"          # "auto" | True | False
...
STAGE10_2_LENGTH_BUCKETING = True    # True | False
...
STAGE10_2_TORCH_THREADS = "auto"        # "auto" | N | 0
...
STAGE10_2_POOL_START_METHOD = "forkserver"    # "auto" | "spawn" | "fork" | "forkserver"
...
STAGE10_3_TOX21_AUTO_RESUME = "auto-resume"   # None = ask on a TTY, auto-resume when
...
STAGE10_SPLIT_MODE = "random"   # "scaffold" | "molecule" | "random"
STAGE10_VAL_FRAC   = 0.20
...
STAGE9_TOX21_MODEL_DIR = f"{_OUT}/stage10_3_tox21_classifier/"   # TODO: set to your trained Tox21 ChemBERTa checkpoint directory
...
STAGE1B_PLIP_SAMPLE_N      = 100000  # default sample size (overridable via --n)
