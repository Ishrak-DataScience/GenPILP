...
# the machine doing the import. Set GENPLIP_CONFIG=laptop to force this one.
# Meant for: the Windows laptop -- self-tests and small local runs. Unlike
# Colab and HPC this machine does NOT keep inputs and outputs under one root,
# so the four input paths below are pinned absolutely instead of derived from
# BASE_DIR. Every other line is config_colab.py verbatim.
CONFIG_PLATFORM = "laptop"

# ── Root directory ─────────────────────────────────────────────────────────────
BASE_DIR    = r"C:/Users/hasin/Desktop/Graduate study/CMS/Team Project/GenPLIP/outputs"  # outputs only; inputs are pinned below
USER_PREFIX = "Ishrak"
...
BASE_PDB_PATH = r"C:/Users/hasin/Desktop/Graduate study/CMS/Team Project/Dummy_data/pdb/"                 # 65 structures (outer)
BASE_XML_PATH = r"C:/Users/hasin/Desktop/Graduate study/CMS/Team Project/Dummy_data/Dummy_data/plip/"     # 6 PLIP XMLs (inner)
REF_CSV_PATH  = r"C:/Users/hasin/Desktop/Graduate study/CMS/Team Project/Dummy_data/Dummy_data/BR4_PDB_Data.csv"
...
# Laptop: the archive sits beside the other inputs under Team Project/Dummy_data,
# summary CSV read straight out of the tar.gz without full extraction.
STAGE9_9A_STAGE1B_DATA_DIR = r"C:/Users/hasin/Desktop/Graduate study/CMS/Team Project/Dummy_data/stage1b_output.tar.gz"
...
STAGE10_1_CHECKPOINT_EVERY_STEPS = 100
...
STAGE1B_PLIP_NEGATIVE_MASK_DIR = "C:/Users/hasin/Desktop/Graduate study/CMS/Team Project/GenPLIP"
